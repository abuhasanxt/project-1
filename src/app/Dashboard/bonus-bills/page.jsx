...
//           <>
//             <label className="block text-gray-700 font-medium mb-2">
//               Number of invoices * <span className="text-red-500">*</span>
//             </label>
//             <input
//               type="number"
//               value={bonusCount}
...
//               </p>
//               <p className="text-gray-700">
//                 <span className="font-medium">Bonus Bills:</span>{" "}
...
//       // 👉 তোমার Backend API URL এখানে বসাও
...
//           text: "Your bonus request has been recorded.",
//           icon: "success",
...
//   return (
//     <div className="min-h-screen bg-gray-50 flex justify-center items-center p-6">
//       <div className="bg-white rounded-2xl shadow-md w-full max-w-3xl border border-gray-200 p-6 relative">
//         {/* ✅ Success Popup */}
//         {success && (
//           <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-green-100 text-green-700 border border-green-300 px-6 py-3 rounded-md shadow-md flex items-center gap-2 animate-fade-in">
//             <CheckCircle size={20} />
...
//             <div className="bg-gray-50 p-4 rounded-lg border mb-6">
//               <p className="text-gray-700">
//                 <span className="font-medium text-xl">Invoices:</span>{" "}
//                 {invoice || "Not provided"}
//               </p>
//               <p className="text-gray-700">
//                 <span className="font-medium text-xl">Bonus Bills:</span>{" "}
//                 {bonusCount || "Not provided"}
//               </p>
//             </div>
        ...
        {step === 3 && (
          <div className="bg-gray-50 p-4 rounded-lg border mb-6">
            <h2 className="text-md font-semibold text-gray-800 mb-6 ">
              <h1 className="text-md font-semibold t my-6 text-gray-700 border border-white bg-white p-2">Request for Billing Bonus for Professional Services (%)</h1>
            </h2>
            <div>
              <div className="ml-5">
